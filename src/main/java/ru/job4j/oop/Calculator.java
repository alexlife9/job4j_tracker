 ...
 *
 * Статические методы обычно используются для выполнения операции,
 * не зависящей от создания экземпляра.
 ...
 *
 * В JDK служебные классы используются: Collections, Math, Arrays.
 * Все методы этих классов являются статическими.
 *
 * Когда стоит использовать статические методы^
 * 1. Для доступа или управления статическими переменными и другими статическими методами,
 * которые не зависят от объектов;
 ...
 * 3. Нестатические методы могут обращаться непосредственно как к методам класса,
 * так и к переменным класса;
 * 4. Нестатические методы могут обращаться к статическим переменным и статическим методам;
 * 5. Статические методы могут обращаться ко всем статическим переменным и
 * другим статическим методам.
